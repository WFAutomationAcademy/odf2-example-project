...
public class MultiProcessErrorHandlingLogic extends MultiProcessErrorHandling {
    ...
    public MultiProcessErrorHandlingLogic(TaskInput taskInput, CurrentTransaction currentTransaction, TransactionRepository transactionRepository, JoinRepository joinRepository,
            FailFastErrorHandling failFastErrorHandling, ErrorRepository errorRepository, OdfTime odfTime, RpaExceptionScreenshotUploader rpaExceptionScreenshotUploader) {
        super(taskInput, currentTransaction, transactionRepository, joinRepository, failFastErrorHandling, LoggerFactory.getLogger(MultiProcessErrorHandlingLogic.class),
