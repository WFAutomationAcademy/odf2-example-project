...
public class MultiProcessErrorHandlingLogic extends MultiProcessErrorHandling {
    ...
    public MultiProcessErrorHandlingLogic(TaskInput taskInput, CurrentTransaction currentTransaction, TransactionRepository transactionRepository, JoinRepository joinRepository, FailFastErrorHandling failFastErrorHandling, ErrorRepository errorRepository, OdfTime odfTime, RpaExceptionScreenshotUploader screenshotUploader) {
        super(taskInput, currentTransaction, transactionRepository, joinRepository, failFastErrorHandling, errorRepository, odfTime, screenshotUploader);
    }
